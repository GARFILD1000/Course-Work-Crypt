...
int TempColor(){          
    ...
    do{ 
        ...
        case 1:                       
            ...
            switch(button){
            case 80: 
                if (temp_color.red>20) temp_color.red-=5; 
                else temp_color.red=0; 
            break;
            case 72: 
                if (temp_color.red==0) temp_color.red+=20; 
                else if (temp_color.red<255) temp_color.red+=5; 
                else temp_color.red=255; 
            break;
        ...
        case 2:                  
            ...
            case 77: if (point_color < 3) point_color++; break;
            case 80: 
                if (temp_color.green > 20) temp_color.green-=5; 
                else temp_color.green=0; 
            break;
            case 72: 
                if (temp_color.green == 0) temp_color.green+=20; 
                else if (temp_color.green < 255) temp_color.green+=5; 
                else temp_color.green=255; 
            break;
            case 13: return 1;
            case 27: return 0;
            };                      
        ...
        case 3:                      
            ...
            case 77: if (point_color < 3) point_color++; break;
            case 80: 
                if (temp_color.blue > 20) temp_color.blue-=5; 
                else temp_color.blue=0; 
            break;
            case 72: 
                if (temp_color.blue == 0) temp_color.blue+=20; 
                else if (temp_color.blue < 255) temp_color.blue+=5; 
                else temp_color.blue=255; 
            break;
            case 13: return 1;
            case 27: return 0;
            };                      
...
//загрузка производится посредством вызова функции ThemeInit, которой передаётся путь к файлу темы
void Themes(int point){
    switch(point){
    case 1:
        setcolor(RGB(punkt_color.red,punkt_color.green,punkt_color.blue));
...
void Design(){ 
    ...
    do{
        ...
        case 13: 
            switch(point){
            case 1: ColorThemes(); return; 
            case 2: ColorSettings(); return;
            case 3: return; 
            };
        case 27:  return;              
        };                             
